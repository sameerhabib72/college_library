		...
		<div class="margin-top">
			...
			<div class="span2">			     
										<ul class="nav nav-tabs nav-stacked" style="background-color: white">
											<li>
											<a href="#add_user" data-toggle="modal" style="background-color: #377ab7"><i class="icon-plus icon-large"></i>&nbsp;<strong style="color: white">Add User</strong></a>
											</li>
										</ul>
	...
	<?php include('modal_add_user.php'); ?>
			...
			<div class="span10">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                <div class="alert alert-info"  style="background-color: #377ab7">
