	...
	<div class="navbar navbar-fixed-top navbar-inverse" >
            <div class="navbar-inner" style="background-color: #337ab7">
                <div class="container">
					...
					<li class="divider-vertical"></li>
					<li class="">
					<a rel="tooltip"  data-placement="bottom" title="Click Here to About" id="login" href="librarian/dashboard.php"><i class="icon-user icon-large"></i>&nbsp;Admin</a>
					</li>
