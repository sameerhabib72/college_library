...
<?php include('navbar_books.php'); ?>
    <div class="container">
		<div class="margin-top">
			...
			<div class="span12">	
             ...
             <div class="alert alert-info" style="background-color: #377ab7">Add Books</div>
			<p><a href="books.php" class="btn btn-info"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a></p>
	<div class="addstudent">
	<div class="details" style="background-color: #377ab7">Please Enter Details Below</div>		
	...
	<input type="text"  class="span4" id="inputPassword" name="author"  placeholder="Author" required>
		...
		<div class="control-group">
			<label class="control-label" for="inputPassword">Book Acc. No:</label>
			<div class="controls">
			<input type="text"  class="span4" id="inputPassword" name="book_pub"  placeholder="Book Acc. No" required>
			</div>
		</div>
		<div class="control-group">
